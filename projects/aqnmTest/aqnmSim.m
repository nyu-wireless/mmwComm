	...
	methods
		function obj = aqnmSim(varargin)
			...
			obj.rffe = mmwsim.rffe.RFFERx(...
				'lnaAmpLut', obj.lnaAmpLut, 'lnaGain', obj.lnaGain, ...
				'lnaNF', obj.lnaNF, 'lnaPower', obj.lnaPower, ...
				'mixAmpLut', obj.mixAmpLut, 'mixGain', obj.mixGain, ...
				'mixNF', obj.mixNF, 'mixPLO', obj.mixPLO, ...
				'mixPower', obj.mixPower, ...
				'fsamp', obj.fsamp, ...
				'nbits', obj.nbits, 'nrx', obj.nrx, 'isLinear', obj.isLinear);
		end
